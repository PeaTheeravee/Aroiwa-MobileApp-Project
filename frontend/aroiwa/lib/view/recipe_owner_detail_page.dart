...
class _RecipeOwnerDetailPageState extends State<RecipeOwnerDetailPage> {
  ...
  Future<void> fetchPersonalScore() async {
    ...
    final url =
        Uri.parse('http://10.0.2.2:8000/scores/personal/$userId/$recipeId');
  ...
  Future<bool> postScoreCheck(int recipeId) async {
    ...
    final url =
        Uri.parse('http://10.0.2.2:8000/scores/canpost/$userId/$recipeId');
  ...
  void deleteRecipe() async {
    ...
    final url = Uri.parse('http://10.0.2.2:8000/recipes/$recipeId/delete');
